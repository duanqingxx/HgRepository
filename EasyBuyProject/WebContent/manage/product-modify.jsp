...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改商品</h2>
		<div class="manage">
			<form  enctype="multipart/form-data" action="../EProductServlet?type=updPro&ep_id=${param.ep_id}" method="post">
				<table class="form">
					<tr>
						<td class="field">商品名称(*)：</td>
						<td><input type="text" class="text" name="productName" value="${param.ep_name }" /></td>
					</tr>
                    <tr>
						<td class="field">描述：</td>
						<td><input type="text" class="text" name="productDetail" value="${param.ep_description}"/></td>
					</tr>
					<tr>
						<td class="field">所属分类：</td>
						<td>
							<select name="parentId2" epc_id="${param.epc_id}">
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice" value="${param.ep_price}"/> 元</td>
					</tr>
					
					<tr>
						<td class="field">库存(*)：</td>
						<td><input type="text" class="text tiny" name="productNumber" value="${param.ep_stock}"/></td>
					</tr>
					<tr>
						<td class="field">商品图片：</td>
						<td><input type="file" class="text" name="photo" />100*100</td>
					</tr>
					<tr>
						<td class="field">商品图片(*)：</td>
