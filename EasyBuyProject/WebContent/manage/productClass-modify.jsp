...
<script type="text/javascript" src="../scripts/productClass-modify.js"></script>
</head>
<body>
...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改分类</h2>
		<div class="manage">
			<form action="../EProCateServlet?type=updEPCate&epc_id=${param.epc_id}" method="post">
				<table class="form">
				<c:if test="${param.epc_id2!=0}">
					<tr>
						<td class="field">父分类：</td>
						<td>
							<select name="parentId" pid="${param.epc_id2 }">
					...
					<tr>
						...
						<td><input type="text" class="text" name="className" value="${param.epc_name }" /></td>
					</tr>
					<tr>
						<td></td>
